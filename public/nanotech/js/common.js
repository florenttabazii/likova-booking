...
---------------------------------------------------*/
	...
	window.ScrollEffects = function() {
		...
		$("#hero #hero-caption.landing-page-title .inner").mouseenter(function(e) {    
			...
			$("#ball").append('<img class="eyes-icon" src="images/scissors.png" style="transform:scale(0.75);">');
		
			// Funcție pentru schimbarea imaginilor între cele trei
			let imageIndex = 0;
			const images = [
				'<img class="eyes-icon" src="images/scissors.png" style="transform:scale(0.75);">',
				'<img class="eyes-icon" src="images/scissors.png" style="transform:scale(0.75);">'  // A treia imagine
			];
